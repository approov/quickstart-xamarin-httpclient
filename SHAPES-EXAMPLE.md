...
* Nuget packages supporting the native Approov SDK: `ApproovSDK` version `3.1.2`, `ApproovHttpClient` version `3.1.0` and `Square.OkHttp3` version `4.2.2` if targetting Android

...
try {
    ...
    // failure due to the attestation being rejected, e.ARC and e.RejectionReasons
    // may be used to present information to the user (note e.RejectionReasons is only
...
// if the provided secret name not defined
```
